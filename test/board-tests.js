...
describe('Board', function() {
  ...
  describe('drop', function() {
    it('cannot drop into column index -1', function() {
      expect(board.drop.bind(board, '-1', 'R')).to.throw(Error, 'Errors!');
    });

    it('cannot drop into column index greater than size of board', function() {
      expect(board.drop.bind(board, '8', 'R')).to.throw(Error, 'Errors!');
    });
    ...
    it('cannot drop into full column', function() {
      ...
      expect(board.drop.bind(board, '0', 'R')).to.throw(Error, 'Errors!');
    });
